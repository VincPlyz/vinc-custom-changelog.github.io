...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.1-snapshot-11%201170x500.jpg" alt="26.1 Snapshot 11 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Misode Diff: https://misode.github.io/versions/?id=26.1-snapshot-11&tab=diff

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=BJ1uLeZKKyc) / [Technical]()
...
<strong>Developer's Note:</strong> Default block state is used in very few contexts, most notably `/setblock` without any properties. This change was done to align default orientation of those blocks with other ones (like Skulls or Dispensers)
</div>
...
-   [MC-199975](https://mojira.dev/MC-199975) - Endermen holding bells or bell block display entities only render the bell frame
-   [MC-231663](https://mojira.dev/MC-231663) - Dragon eggs do not check whether there is a block under their destination when teleporting
-   [MC-275014](https://mojira.dev/MC-275014) - Weathered and oxidized copper bulbs cast stronger shadows on themselves when lit with smooth lighting enabled
-   [MC-301003](https://mojira.dev/MC-301003) - The bell part of bells worn on copper golems' "saddle" is not visible
-   [MC-303344](https://mojira.dev/MC-303344) - Tooltips for selected items in dialogs are displayed even when the item isn't being hovered over
-   [MC-304683](https://mojira.dev/MC-304683) - Wandering traders don't spawn in single biome snowy plains worlds
-   [MC-304796](https://mojira.dev/MC-304796) - Hovering over a disabled slider shows the pointing hand cursor instead of the forbidden cursor
-   [MC-305797](https://mojira.dev/MC-305797) - The texture of the warm piglet contains unused pixels
-   [MC-305857](https://mojira.dev/MC-305857) - Entity hitboxes now move jaggedly when the game is frozen
-   [MC-306082](https://mojira.dev/MC-306082) - The back texture of one of baby woods wolves' legs is inconsistent with the other three legs
-   [MC-306110](https://mojira.dev/MC-306110) - The side textures of black, white splotched, killer, and Toast rabbits' heads extend to the bottom of their heads
-   [MC-306180](https://mojira.dev/MC-306180) - Hitting a rolled up baby armadillo causes its legs to stick out and z-fight with the shell
-   [MC-306190](https://mojira.dev/MC-306190) - The game closes when upgrading a world fails
-   [MC-306303](https://mojira.dev/MC-306303) - Plains zombie villagers use the texture of their baby variant
-   [MC-306309](https://mojira.dev/MC-306309) - Some new animal sound variants are missing
-   [MC-306312](https://mojira.dev/MC-306312) - Some strings introduced in 26.1 Snapshot 7 are grammatically incorrect
-   [MC-306466](https://mojira.dev/MC-306466) - The back texture of baby pandas' heads has a black stripe on one of its edges
-   [MC-306472](https://mojira.dev/MC-306472) - The texture of chainmail helmets on baby humanoid mobs has no transparent pixels on its top, unlike on adult mobs
-   [MC-306483](https://mojira.dev/MC-306483) - Golden dandelions do not prevent baby trader llamas from despawning
-   [MC-306520](https://mojira.dev/MC-306520) - Baby donkeys and baby mules are offset from their hitbox, and their tail is offset from their body
-   [MC-306607](https://mojira.dev/MC-306607) - Endermen now display the block-holding pose even when empty-handed
-   [MC-306608](https://mojira.dev/MC-306608) - Glow item frames now resemble item frames
-   [MC-306625](https://mojira.dev/MC-306625) - The "Programmer Art" and "High Contrast" resource packs are listed as incompatible
-   [MC-306639](https://mojira.dev/MC-306639) - The worried baby panda's model is broken when hiding its face during a thunderstorm
-   [MC-306676](https://mojira.dev/MC-306676) - The bottom texture of snifflets is made up of solid colors
