...
-   Updated visuals for the following mobs:
    -   Panda
        ...
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-8/panda.png" alt="">

    -   Hoglin

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-8/hoglin.png" alt="">

    -   Zoglin

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-8/zoglin.png" alt="">

    -   Strider

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-8/strider.png" alt="">

    -   Snifflet

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-8/snifflet.png" alt="">
