...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.1-snapshot-3%201170x500.jpg" alt="26.1 Snapshot 2 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=YLHTLf8RNIs) / [Technical](https://www.youtube.com/watch?v=ILnYqYftvX4)
...
-   The Game Rules screen is now accessible in-game through a new World Options screen in the pause menu
    ...
    <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-3/gamerules.png" alt="">
...
-   The World Options screen contains the difficulty button as well as a button for changing Game Rules
    ...
    <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-3/world_options.png" alt="">
...
-   `result` field should now be more consistent across all recipe types that contain it
    ...
    -   For recipe types `smelting`, `blasting`, `smoking` and `campfire_cooking` this field now also accepts `count` field
        - Example:
        <video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-3/recipe.mp4" muted autoplay loop controls></video>
...
- Some examples showcasing what these new block tags allow us to control:

    - Placing/Growing Crops on all Blocks:
    <video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-3/veg.mp4" muted autoplay loop controls></video>

    - Which Blocks create Up/Downwards Water Columns
    <video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-3/water.mp4" muted autoplay loop controls></video>

    - Which Blocks Sugar Cane needs to be placeable
    <video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-3/cane.mp4" muted autoplay loop controls></video>
...
-   [MC-297536](https://mojira.dev/MC-297536)- Z-fighting occurs on the debug crosshair
-   [MC-299992](https://mojira.dev/MC-299992)- Unexpected behavior when giving or testing for an item with certain components manually specified as their default values
-   [MC-305105](https://mojira.dev/MC-305105)- The spear in an entity's main hand gets animated when their off hand arm is swung using /swing
-   [MC-305156](https://mojira.dev/MC-305156)- Dialog elements are not displayed until the UI is refreshed
-   [MC-305251](https://mojira.dev/MC-305251)- Breezes are aggressive toward every mob
-   [MC-305261](https://mojira.dev/MC-305261)- The enchant_with_levels and enchant_randomly functions can crash the game
-   [MC-305292](https://mojira.dev/MC-305292)- Copper chests use the Christmas present texture
-   [MC-305459](https://mojira.dev/MC-305459)- Villagers spawned from spawn eggs use the biome at the world origin (0, 0, 0) for their variant
-   [MC-305540](https://mojira.dev/MC-305540)- Wandering traders sell pumpkins instead of kelp for 3 emeralds
-   [MC-305577](https://mojira.dev/MC-305577) - Piglins no longer flee from greater numbers of hoglins
