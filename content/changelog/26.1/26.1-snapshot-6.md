...
-   Updated the models and textures of the following baby mobs:
    -   Bee
        ...
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/bee.png" alt="" style="width:600px;"/>

    -   Fox

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/fox.png" alt="" style="width:600px;"/>

    -   Goat

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/goat.png" alt="" style="width:600px;"/>

    -   Camel

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/camel.png" alt="" style="width:600px;"/>

    -   Armadillo

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/armadillo.png" alt="" style="width:600px;"/>

    -   Polar Bear

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/polar_bear.png" alt="" style="width:600px;"/>

    -   Llama

        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/llama.png" alt="" style="width:600px;"/>
