...
- Die world struktur wurde aufgeräumt | statt DIM1 und DIM-1 sind die dimensionen alle ordentlich im "dimensions" ordner als `the_nether`, `the_end` und `overworld`
    ...
    - Old
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/alt.png" alt="" style="width:600px;"/>

    - New
            <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/neu.png" alt="" style="width:600px;"/>
