---
title: "26.1 Snapshot 6 Changelog"
description: ""
...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.1-snapshot-6_1170x500.jpg" alt="26.1 Snapshot 6 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=_I5g7zBkDK0) / [Technical](https://www.youtube.com/watch?v=WJTVsDD_eoQ)
...
-   Updated the models and textures of the following baby mobs:
    ...
    -   Bee {{< wiki "Bee" >}}
        ...
        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Bee_JE3.gif?693e6&format=original|New|0.5|0px|20px"
        "https://minecraft.wiki/images/Bee_JE1.gif?69ac5&format=original|Old|1|0px|-10px"
         >}}
    ...
    -   Fox {{< wiki "Fox" >}}
        ...
        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Fox_JE2.png?ea686&format=original|New|0.8|20px|0px"
        "https://minecraft.wiki/images/Baby_Fox_JE1_BE1.png?41027&format=original|Old|0.45|0px|20px"
         >}}
    ...
    -   Goat {{< wiki "Goat" >}}
        ...
        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Goat_JE2_BE3.png?d6a36&format=original|New|0.4|-40px|-20px"
        "https://minecraft.wiki/images/Baby_Goat_JE1_BE2.png?c3c0a&format=original|Old|0.35|0px|0px"
         >}}
    ...
    -   Camel {{< wiki "Camel" >}}
        ...
        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Camel_Idle.gif?dd4cf&format=original|New|0.6|0px|0px"
        "https://minecraft.wiki/images/Camel_Idle.gif?72667&format=original|Old|0.56|0px|0px"
         >}}

    -   Armadillo {{< wiki "Armadillo" >}}

        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Armadillo_JE3.png?03f97&format=original|New|0.85|-10px|0px"
        "https://minecraft.wiki/images/Armadillo_JE2_BE2.png?9cdf1&format=original|Old|0.3|50px|-20px"
         >}}

    -   Polar Bear {{< wiki "Polar_bear" >}}

        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Polar_Bear_JE7_BE3.png?286e6&format=original|New|0.4|0px|0px"
        "https://minecraft.wiki/images/Baby_Polar_Bear_JE6.png?1b9df&format=original|Old|0.4|0px|0px"
         >}}
    ...
    -   Llama {{< wiki "Llama" >}}
        ...
        {{< carousel
        " "
        "https://minecraft.wiki/images/Baby_Brown_Llama_JE3_BE3.png?c2f1c&format=original|New|0.3|0px|0px"
        "https://minecraft.wiki/images/Baby_Brown_Llama.png?6e6be&format=original|Old|0.3|0px|0px"
         >}}
...
<strong>Developer's Note:</strong> Due to additional risk when upgrading a world, we will be forcing a backup when you load your world for the first time in this snapshot cycle. After upgrading, you will not be able to load your world in an older version at all.
</div>
...
- Die world struktur wurde aufgeräumt | statt DIM1 und DIM-1 sind die dimensionen alle ordentlich im "dimensions" ordner als `the_nether`, `the_end` und `overworld`

    - Old World Folder
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/oldt.png" alt="" style="width:600px;"/>

    - New World Folder
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/newt.png" alt="" style="width:600px;"/>

    - New level.dat
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/leveldat_newt.png" alt="" style="width:600px;"/>

    - Old level.dat
        <img src="/vinc-custom-changelog.github.io/images/26.1/snapshot-6/leveldat_oldt.png" alt="" style="width:600px;"/>
...
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - /data produces a positive result for low negative numbers
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Spawners with their light limits set to ranges that don't include 15 don't spawn mobs under the night sky
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Crash when generating water lakes using a custom worldgen datapack
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Hanging sign block displays render dark and above other blocks and mobs
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Baby zombie horses, skeleton horses and camel husks grow into adults, unlike other baby undead mobs
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - The "wolf_baby_angry4" sound (angry puppy sound) ends abruptly
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - The game crashes due to an integer overflow when loading a level with a large number of days
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - The eating sound for baby horses is noticeably too low-pitched
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Bubble columns delete waterlogged blocks that intersect them
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Golden dandelions can't be fed to tadpoles
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Golden dandelions work on tamed baby skeleton horses and zombie horses
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - The "Birthday Song" advancement is no longer being granted
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - The AgeLocked NBT tag isn't saved when picking up a baby axolotl in a bucket
-   [MC-134573][https://bugs.mojang.com/browse/MC-134573] - Wolves still try to attack players even in Peaceful difficulty
