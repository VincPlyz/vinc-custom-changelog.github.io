...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.1-snapshot-1-1170x500.jpg" alt="26.1 Snapshot 1 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=3TQ8ch8bN4A) / [Technical](https://www.youtube.com/watch?v=iymV0-l0HUE)

Snapshot Datapack: <a href="/vinc-custom-changelog.github.io/file_share/26_1_snapshot-1_Datapack.zip" download="Snapshot Datapack">Download</a>
...
<video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-1/lightmap.mp4" muted autoplay loop controls></video>
...
- Custom Biome Dependent Villager Trades
<video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-1/datadriven_villager_trades.mp4" muted controls></video>
...
{{< command >}}/swing @n[type=mannequin] mainhand{{< /command >}}

<video src="/vinc-custom-changelog.github.io/videos/26.1/snapshot-1/swing_command.mp4" muted autoplay loop controls></video>
...
- [MC-64087](https://mojira.dev/MC-64087) - Revengeful zombies / Zombie reinforcements will try to attack you in Creative mode
- [MC-179949](https://mojira.dev/MC-179949) - You cannot edit the inventories of piglins by using '/item replace'
- [MC-197497](https://mojira.dev/MC-197497) - Smooth lighting transition from level 1 to 0 is not smooth
- [MC-199589](https://mojira.dev/MC-199589) - Hitting mobs in Creative mode then switching into Survival causes the mob to target you
- [MC-219981](https://mojira.dev/MC-219981) - Leader zombie-type mobs spawn with 20 health despite having an increased maximum health
- [MC-300465](https://mojira.dev/MC-300465) - Maps with the maximum number of markers cannot be placed in item frames
- [MC-302186](https://mojira.dev/MC-302186) - Ambient lighting in the Nether appears discolored compared to previous versions
- [MC-302408](https://mojira.dev/MC-302408) - Inconsistent underwater lighting with the Conduit Power effect applied
- [MC-302528](https://mojira.dev/MC-302528) - Low sky & block light look outright broken when cast on the same area
- [MC-303119](https://mojira.dev/MC-303119) - Feeding a cat or wolf in Survival mode with only one item in the selected item slot does not restore as much health as it should
- [MC-303125](https://mojira.dev/MC-303125) - Creepers can blow up after the player dies
- [MC-303389](https://mojira.dev/MC-303389) - The ender dragon's velocity can be affected by attacks while perched
- [MC-303692](https://mojira.dev/MC-303692) - Debug overlay text has an indent when improved transparency is disabled
- [MC-304023](https://mojira.dev/MC-304023) - Redundant level data fixer files are saved in worlds' "data" folder
- [MC-304217](https://mojira.dev/MC-304217) - Lunge's hunger requirement applies to post_piercing_attack effects of custom enchantments
- [MC-304599](https://mojira.dev/MC-304599) - Dolphins don't follow players riding nautiluses like in Bedrock Edition
- [MC-304631](https://mojira.dev/MC-304631) - Anisotropic filtering set to 8x causes opaque translucent textures to become transparent in the distance when there are odd-sized block textures
- [MC-304725](https://mojira.dev/MC-304725) - Zombie villagers summoned with default spawn eggs always spawn as their plains variant
- [MC-304991](https://mojira.dev/MC-304991) - Clicking on a chest with loot that hasn't been generated in Spectator mode makes the "block.chest.locked" sound
- [MC-305012](https://mojira.dev/MC-305012) - The description of the "Universal anger" game rule still uses the old ID of the "Forgive dead players" game rule
