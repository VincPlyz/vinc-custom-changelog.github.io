...
Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=a8gPl8AIRz4) / [Technical](https://www.youtube.com/watch?v=ePEvmb1BLKY)
...
-   [MC-102774](https://mojira.dev/MC-102774) - You can respawn the ender dragon with only two end crystals
-   [MC-163978](https://mojira.dev/MC-163978) - Mobs can spawn on moving blocks
-   [MC-260148](https://mojira.dev/MC-260148) - show_notification only works for shaped crafting recipes
-   [MC-305145](https://mojira.dev/MC-305145) - Emissive elements of items are invisible in the GUI
-   [MC-305388](https://mojira.dev/MC-305388) - Bees never cease to be angry
-   [MC-305457](https://mojira.dev/MC-305457) - The targeted fluid is always displayed as "empty" in the debug overlay
-   [MC-305692](https://mojira.dev/MC-305692) - The World Options menu does not display or update properly for clients connected to dedicated servers
-   [MC-305693](https://mojira.dev/MC-305693) - Smelting recipes do not add the correct count of items to the output
-   [MC-305698](https://mojira.dev/MC-305698) - Some functions fail to load due to "components not bound yet"
-   [MC-305732](https://mojira.dev/MC-305732) - Dedicated server operators can make all monsters despawn unintentionally with the World Options screen
-   [MC-305847](https://mojira.dev/MC-305847) - Closed captions for baby horses are untranslated
-   [MC-305850](https://mojira.dev/MC-305850) - Translucent blocks and fluids are no longer visible behind translucent particles if "Improved Transparency" is disabled
-   [MC-305886](https://mojira.dev/MC-305886) - Unused sound event 'entity.baby_horse.fall'
-   [MC-305888](https://mojira.dev/MC-305888) - Turtle eggs no longer hatch in the Nether or the End
