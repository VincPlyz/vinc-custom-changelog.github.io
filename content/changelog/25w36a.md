...
*   Die Farben von Copper Torches und Copper Lanterns wurden angepasst, damit sie für farbenblinde Spieler besser erkennbar sind.
    ...
    Total gut Funktionierende Image Compare Embeds:
    - [Lantern](https://cdn.knightlab.com/libs/juxtapose/latest/embed/index.html?uid=cc3d1dda-881a-11f0-bb24-0936e1cb08fb) 
    - [Torch](https://cdn.knightlab.com/libs/juxtapose/latest/embed/index.html?uid=ada2c718-881e-11f0-bb24-0936e1cb08fb)
...
- > Dev Comments über die Mannequins/NPC's und dem "NPC" Tag den man nicht entfernen können soll (in Vanilla zumindest)
...
- Mannequin datapack usecase beispiele der Community:
   ...
   - basic replay system by dontgiveadam (MCC Discord) <video src="/vinc-custom-changelog.github.io/videos/25w36a/basic_replay.mp4" muted style="width:500px;" controls></video>
