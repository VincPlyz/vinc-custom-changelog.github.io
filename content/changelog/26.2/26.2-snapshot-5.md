---
title: "26.2 Snapshot 5 Changelog"
description: ""
...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.2-snapshot-5_1170x500.jpg" alt="26.2 Snapshot 5 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=iVVKhbPs7IQ) / [Technical]()

Misode Diff: https://misode.github.io/versions/?id=26.2-snapshot-5&tab=diff

Snapshot Datapack: <a href="/vinc-custom-changelog.github.io/file_share/26.2 Snapshot 5 Datapack.zip" download="Snapshot 5 Datapack">Download</a>
...
-   There is now a third special archetype:
  ...
  <video src="/vinc-custom-changelog.github.io/videos/26.2/snapshot-5/tnt_cube.mp4" loop controls></video>
...
-   Extra: Die Höhe der Geyser Partikel und des Effekts erhöht sich mit jeder Wasserquelle von 1-4 um 5 Blöcke
  ...
  <video src="/vinc-custom-changelog.github.io/videos/26.2/snapshot-5/geyser.mp4" loop controls></video>
...
-   Added sounds for Geyser eruptions [New Sounds \\/](#sounds-1)
...
<strong>Developer's Note:</strong> Touch screen mode has been poorly implemented and not properly supported for a long time. We plan to deprecate this feature in this release. To provide your feedback on this topic, head over to the feedback site.
</div>
...
-   Added sounds for Geyser eruptions:
    ...
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption1.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption2.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption3.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption4.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption5.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption6.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption7.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption8.ogg" icon="fas fa-volume-up" volume="1.0" >}}

    -   `block.potent_sulfur.geyser_eruption_active`
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active1.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active2.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active3.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active4.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active5.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active6.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active7.ogg" icon="fas fa-volume-up" volume="1.0" >}}
    {{< audiobutton url="https://raw.githubusercontent.com/misode/mcmeta/26.2-snapshot-5-diff/assets/minecraft/sounds/block/potent_sulfur/sulfur_spring/eruption_active8.ogg" icon="fas fa-volume-up" volume="1.0" >}}
...
-   [MC-304862](MC-304862) - Activating a dispenser with a hostile mob spawn egg in Peaceful difficulty consumes the egg and plays a sound
-   [MC-306622](MC-306622) - The height of chicken jockeys is slightly off
-   [MC-306685](MC-306685) - The riding position on baby hoglins is too low
-   [MC-307012](MC-307012) - When a scoreboard objective is set to the `below_name` display mode, all named entities with no score display it with a score of 0
-   [MC-307125](MC-307125) - Target selectors with duplicate `team` arguments are parsed inconsistently depending on argument order
-   [MC-307194](MC-307194) - The discount given by fletchers for tipped arrow trades decreases the arrow cost instead of the emerald cost
-   [MC-307266](MC-307266) - Zombie villagers change biome type after being cured
-   [MC-307283](MC-307283) - Placing sulfur springs using /place does not update the affected blocks
-   [MC-307513](MC-307513) - Using /deop on multiple players shows the same player in all success messages
-   [MC-307623](MC-307623) - Chunk sections are sometimes invisible until they are updated
-   [MC-307689](MC-307689) - The player's arm swings when failing to use a spawn egg in Peaceful difficulty
-   [MC-307690](MC-307690) - The error message produced by /difficulty doesn't use the difficulty's translated name
-   [MC-307702](MC-307702) - Skeletons' AI breaks when picking up any item
-   [MC-307706](MC-307706) - The game inconsistently refers to name tags and name plates
-   [MC-307710](MC-307710) - Deoxidizing waxed copper blocks now takes priority over scraping off the wax
-   [MC-307754](MC-307754) - Monsters now spawn regardless of the "Spawn Monsters" game rule
