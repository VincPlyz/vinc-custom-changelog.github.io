---
title: "26.2 Snapshot 3 Changelog"
description: ""
...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/26.2-snapshot-3%201170x500.jpg" alt="26.2 Snapshot 3 Header" />
  <div class="mc-news-label">News</div>
</div>

<div class="mc-article">

Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=yXBeZqfkXas) / [Technical](https://www.youtube.com/watch?v=mD4nduuih1g)

Misode Diff: https://misode.github.io/versions/?id=26.2-snapshot-3&tab=diff

Snapshot Datapack: <a href="/vinc-custom-changelog.github.io/file_share/26.2 Snapshot 3 Datapack.zip" download="Snapshot 3 Datapack">Download</a>
...
### Sulfur Spike {{< wiki "Sulfur_Spike" >}}

<img src="/vinc-custom-changelog.github.io/images/26.2/snapshot-3/sulfur_spike.png" alt="" style="width:600px;"/>
...
<div class="image-comp" style="--max-width: 1339px;">
  <div id="left">
    <img src="/vinc-custom-changelog.github.io/images/26.2/snapshot-3/blockset_old.png" alt="Bild 1" />
    <span class="alt-text-overlay top-left">New</span>
  </div>
  <div id="right">
    <img src="/vinc-custom-changelog.github.io/images/26.2/snapshot-3/blockset_new.png" alt="Bild 2" />
  </div>
...
-   [MC-229057](https://mojira.dev/MC-229057) - Picking up an axolotl with a lead attached destroys the lead
-   [MC-277744](https://mojira.dev/MC-277744) - Blocks with emissive textures don't emit much light when held by endermen
-   [MC-302496](https://mojira.dev/MC-302496) - Glowing dragon fireballs no longer show the glowing outline
-   [MC-307177](https://mojira.dev/MC-307177) - Enabling JFR profiling causes the client to crash on startup
-   [MC-307227](https://mojira.dev/MC-307227) - Using an empty `Offers` NBT tag to disable trades doesn't work after a relog/data merge
-   [MC-307289](https://mojira.dev/MC-307289) - Polished sulfur is named "Polished Sulfur Block", which is inconsistent with all other polished stone blocks
-   [MC-307291](https://mojira.dev/MC-307291) - The game crashes when an entity with the `friction_modifier` attribute set to 2.5 moves
-   [MC-307298](https://mojira.dev/MC-307298) - Sulfur cubes with blocks inside them produce footstep sounds when moving across the ground
-   [MC-307300](https://mojira.dev/MC-307300) - Magma blocks held by sulfur cubes are not emissive
-   [MC-307315](https://mojira.dev/MC-307315) - Frogs try to eat large magma cubes now
-   [MC-307316](https://mojira.dev/MC-307316) - Magma cubes no longer drop magma cream
-   [MC-307340](https://mojira.dev/MC-307340) - The bottom face of slimes' outer layer z-fights with the ground
-   [MC-307347](https://mojira.dev/MC-307347) - Releasing a sulfur cube from a bucket and killing it does not cause it to drop its held block
-   [MC-307357](https://mojira.dev/MC-307357) - Sulfur cubes don't emit light when holding a glowing block
-   [MC-307371](https://mojira.dev/MC-307371) - The `#sulfur_cube_archetype/fast_flat` item tag contains `pumpkin` twice
-   [MC-307405](https://mojira.dev/MC-307405) - When picking up a leashed sulfur cube with a bucket, the lead disappears
-   [MC-307420](https://mojira.dev/MC-307420) - The game now renders fluid faces that should not be rendered
-   [MC-307473](https://mojira.dev/MC-307473) - The block breaking texture on bamboo stalks is now always displayed centered
-   [MC-307483](https://mojira.dev/MC-307483) - Emptying a sulfur cube bucket underwater doesn't place the sulfur cube at the targeted block
