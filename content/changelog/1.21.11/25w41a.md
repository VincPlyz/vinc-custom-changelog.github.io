...
### Changed `minecraft:consumable`
  ...
  * The `animation` field has been updated:
    ...
    * Added new `spear` animation
     ...
     - {{< command_v2 nowrap="true" >}}/give @s wheat[minecraft:consumable={animation:spear,consume_seconds:9999999},use_effects={can_sprint:true,speed_multiplier:1.0}]{{< /command_v2 >}}
