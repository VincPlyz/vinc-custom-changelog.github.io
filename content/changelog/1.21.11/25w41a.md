...
## Nautilus {{< wiki "Nautilus" >}}
  ...
  {{< list_compare title="" >}}
        {{< list_compare_item 
            label="Nautilus" 
            img="https://minecraft.wiki/images/Nautilus_Breathe_JE1_BE2.gif?af9c0&format=original" 
            width="250px" 
        >}}
        {{< list_compare_item 
            label="Baby Nautilus" 
...
### Lunge Enchantment {{< wiki "Lunge" >}}
  ...
  * ~~Does significant durability damage to the Spear~~
  ...
  {{< command >}}/give @s minecraft:wooden_spear[minecraft:enchantments={lunge:10}]{{< /command >}}
  {{< command >}}/effect give @s minecraft:saturation infinite 255 true{{< /command >}}
