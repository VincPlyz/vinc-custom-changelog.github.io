...
Nautilus            |  Baby Nautilus
:-------------------------:|:-------------------------:
<img src="https://minecraft.wiki/images/Nautilus_JE1.gif" alt="" style="width:250px;"/>  |  <img src="https://minecraft.wiki/images/Baby_Nautilus_JE1.png" alt="" style="width:150px;"/>
...
### Lunge Enchantment {{< wiki "Lunge" >}}
  ...
  * Does significant durability damage to the Spear
  ...
  {{< command >}}/summon silverfish ~ ~ ~ {equipment:{mainhand:{id:"iron_spear",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{"lunge":5}}}}}{{< /command >}}
...
# Changes
  ...
  * Client FPS is expected to be higher for most players
    ...
    - Hermitcraft 10 Map / 32 Chunks:
      1.21.10           |  25w41a
      :-------------------------:|:-------------------------:
      <img src="/vinc-custom-changelog.github.io/images/25w41a/perf_1.21.10.png" alt="" style="width:250px;"/>  |  <img src="/vinc-custom-changelog.github.io/images/25w41a/perf_25w41a.png" alt="" style="width:250px;"/>
...
### Added `minecraft:use_effects`
  ...
  * Format: object with fields
    ...
    * e.g. `use_effects={can_sprint:true,speed_multiplier:1.0}`
    ...
    {{< command >}}/give @p weathered_copper_golem_statue[consumable={consume_seconds:1},food={nutrition:2,saturation:2,can_always_eat:true},use_effects={sprinting:false,speed_multiplier:0},minecraft:max_stack_size=99] 99{{< /command >}}

    - _Consumable, bei dem man sich ganz normal bewegen kann, während man es konsumiert_: 
    {{< command >}}/give @p weathered_copper_golem_statue[consumable={consume_seconds:1},food={nutrition:2,saturation:2,can_always_eat:true},use_effects={sprinting:true,speed_multiplier:1.0},minecraft:max_stack_size=99] 99{{< /command >}}

    - _Huge für Datapacks, weil man vorher mit Items mit dem Consumable Component für RClick detection verlangsamt wurde. bsp:_

      <p style="color:Red;" title="Test">(Benötigt das Snasphot Datapack!)</p>

      - old: {{< command >}}/give @p stick[consumable={consume_seconds:999999999,animation:"none",has_consume_particles:false}]{{< /command >}}

      - new: {{< command >}}/give @p stick[consumable={consume_seconds:999999999,animation:"none",has_consume_particles:false},use_effects={sprinting:true,speed_multiplier:1.0}]{{< /command >}}
...
### Changed `minecraft:consumable`
  ...
  * The `animation` field has been updated:
  ...
  - "We have "Zeige" Emote at Home":
  {{< command >}}/give @s wheat[minecraft:consumable={animation:spear,consume_seconds:9999999},minecraft:item_model=air]{{< /command >}}

### Changed `minecraft:intangible`
