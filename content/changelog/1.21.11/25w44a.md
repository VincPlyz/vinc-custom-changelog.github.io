...
Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=vzoFl5Lodeg) / [Technical](https://www.youtube.com/watch?v=YNvWGMO2LKs)
...
# Fixed bugs in 25w44a
  ...
  * [MC-302678](https://mojira.dev/MC-302678) Arrows and tridents get stuck on players and mobs
  * [MC-303072](https://mojira.dev/MC-303072) Game crashes when a trident entity with PierceLevel ≥ 1 hits a mob or player
  * [MC-303168](https://mojira.dev/MC-303168) Equipping a saddle onto a nautilus uses the "subtitles.entity.horse.saddle" subtitle
  * [MC-303255](https://mojira.dev/MC-303255) Nautiluses do not deal damage if mobGriefing is false
  * [MC-303429](https://mojira.dev/MC-303429) Piglins and hoglins shake in the nether
  * [MC-303432](https://mojira.dev/MC-303432) Chinese input is not recognized
  * [MC-303434](https://mojira.dev/MC-303434) Japanese input is not recognized
  * [MC-303439](https://mojira.dev/MC-303439) Held items in third-person view show strange artifacts when viewed at certain angles
  * [MC-303455](https://mojira.dev/MC-303455) The cursor is no longer centered when opening a container or menu on Wayland
  * [MC-303460](https://mojira.dev/MC-303460) The cursor no longer follows the look set by the system on Wayland
  * [MC-303461](https://mojira.dev/MC-303461) The application icon shows the generic Wayland icon instead of the Minecraft icon on Wayland
  * [MC-303478](https://mojira.dev/MC-303478) Cannot launch 25w43a on Linux with Nvidia Graphics
  * [MC-303481](https://mojira.dev/MC-303481) Game has no audio and crashes with Mac Studio Display
  * [MC-303485](https://mojira.dev/MC-303485) The game can no longer save chunks in custom dimensions
  * [MC-303504](https://mojira.dev/MC-303504) Nether sprouts textures still expand when viewed from a sharp angle
  * [MC-303506](https://mojira.dev/MC-303506) Control-key combinations additionally send the normal letter on Wayland
  * [MC-303520](https://mojira.dev/MC-303520) Sweet berry bush textures still expand when viewed from a sharp angle
  * [MC-303541](https://mojira.dev/MC-303541) The game doesn't boot on Wayland
  * [MC-303651](https://mojira.dev/MC-303651) Rotating dropped items sometimes create visual artifacts