...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/1.21.11-header.jpg" alt="1.21.11 Header" />
...
![](https://launchercontent.mojang.com/v2/images/nautilus1280720.jpg)
...
#### Coral Zombie Nautilus {{< wiki "Zombie_Nautilus#Coral" >}}

![](https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/1.21.11-coral_zombie_nautilus.jpg)
...
![](https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/1.21.11-camel_husk.jpg)
...
![](https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/1.21.11-spear.jpg)
...
# Changes
  ...
  * Added splash text "One does not simply walk to the Far Lands"
    - Dev Note: This statement was proven false on October 4, 2025!

  * Tamed horses no longer run into cacti or sweet berry bushes

## Zombie Horse

![](https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/1.21.11-zombie_horse.jpg)
...
pack.](content/dam/launcher/java_patch_notes/1-21-11/1.21.11-environment_attributes.jpg)
...
* Example:
  ...
  + `{predicates:{instrument:{}}` - checks if component min`ecraft:instrument` exists (was not allowed before)
...
* [MC-2791](https://mojira.dev/MC-2791) - The player model in the inventory screen renders in the wrong orientation when it's not standing up straight
* [MC-22882](https://mojira.dev/MC-22882) - Ctrl + Q doesn't work on Mac
* [MC-53491](https://mojira.dev/MC-53491) - The world border can change in size when the game is paused
* [MC-54988](https://mojira.dev/MC-54988) - World border "warning" effect is not shown when graphics setting is set to "Fast"
* [MC-54989](https://mojira.dev/MC-54989) - Sliders can be moved to positions between available values
* [MC-73186](https://mojira.dev/MC-73186) - Gaps between the faces of item models and complex block models
* [MC-80476](https://mojira.dev/MC-80476) - On macOS, the "drop item stack" shortcut conflicts with the "quit Minecraft" shortcut
* [MC-114265](https://mojira.dev/MC-114265) - Mipmaps are too dark around transparent edges in textures (e.g. side of grass)
* [MC-146862](https://mojira.dev/MC-146862) - Long effect names cause text to appear outside the effect box
* [MC-147718](https://mojira.dev/MC-147718) - F1, F3, F3+[char] combos cannot be rebound
* [MC-149630](https://mojira.dev/MC-149630) - Some particles have very thin, vertical lines that flash in and out around the particles
* [MC-154651](https://mojira.dev/MC-154651) - Boats and rafts can break off paintings and item frames
* [MC-159275](https://mojira.dev/MC-159275) - Map player markers on maps of the nether don't rotate when doDaylightCycle is disabled
* [MC-162573](https://mojira.dev/MC-162573) - A white outline is rendered on composters' edges when viewed from far away
* [MC-171688](https://mojira.dev/MC-171688) - Invisibility status of LivingEntity is not updated when ActiveEffects are modified directly
* [MC-179383](https://mojira.dev/MC-179383) - Leaves not culled with graphics set to Fast
* [MC-188602](https://mojira.dev/MC-188602) - In non-natural custom dimensions, if "bed_works" is set to true, beds cannot be used to skip the night or set the spawn point
* [MC-189837](https://mojira.dev/MC-189837) - Nether fog is dark after rejoining a world that is thunder storming in the Overworld
* [MC-195505](https://mojira.dev/MC-195505) - Short grass is unaffected by mipmap levels
* [MC-199467](https://mojira.dev/MC-199467) - Certain entity animations stop after they've existed in world for too long
* [MC-234358](https://mojira.dev/MC-234358) - Moiré patterns / aliasing on certain objects when viewed from a distance
* [MC-237158](https://mojira.dev/MC-237158) - Magma blocks can generate on the ceilings of caves below aquifers
...
* [MC-241321](https://mojira.dev/MC-241321) - Darkness vignette effect is not shown when graphics setting is set to "Fast"
* [MC-245854](https://mojira.dev/MC-245854) - Fast graphics description is slightly misleading
* [MC-245895](https://mojira.dev/MC-245895) - View Bobbing stops working after long elytra flight
* [MC-248499](https://mojira.dev/MC-248499) - Potion UIs displayed within the inventory don't have cyan outlines if the effects are granted by beacons or conduits
* [MC-259368](https://mojira.dev/MC-259368) - Z-fighting occurs on trimmed armor items
* [MC-263562](https://mojira.dev/MC-263562) - World types in Realms backup info screen are untranslatable
* [MC-264151](https://mojira.dev/MC-264151) - Glass blocks do not use mipmapping, but glass panes do
* [MC-266425](https://mojira.dev/MC-266425) - Recipes for new waxed copper blocks are not grouped
* [MC-267364](https://mojira.dev/MC-267364) - Teleporting in the air is considered flying by server
* [MC-269295](https://mojira.dev/MC-269295) - Jump bar progress renders unused pixels from dynamic texture atlas
* [MC-271729](https://mojira.dev/MC-271729) - Armadillo scute drops are not affected by the mob_drops game rule
* [MC-271938](https://mojira.dev/MC-271938) - Mace smash attack can push players in creative mode that are flying
* [MC-271941](https://mojira.dev/MC-271941) - Music discs can sometimes spawn inside jukeboxes when ejected from them
* [MC-274828](https://mojira.dev/MC-274828) - Horse armor item and entity model tint affects the entirety of the textures
* [MC-276382](https://mojira.dev/MC-276382) - Leather horse armor leggings & helmet parts are untextured
* [MC-276445](https://mojira.dev/MC-276445) - Highlighted text within the anvil and creative inventory interfaces renders blue making it difficult to read
* [MC-277768](https://mojira.dev/MC-277768) - Mipmapping no longer affects items
* [MC-278742](https://mojira.dev/MC-278742) - Creakings cannot be ridden by any entities using commands
* [MC-279076](https://mojira.dev/MC-279076) - Certain mobs will always retarget the player upon reloading the chunks, regardless of distance or gamemode
* [MC-295949](https://mojira.dev/MC-295949) - Flying through vines with an elytra cancels the flight
* [MC-296952](https://mojira.dev/MC-296952) - F4 key to toggle shaders cannot be rebound
* [MC-297328](https://mojira.dev/MC-297328) - Unloading and reloading an area causes invisible entities to be visible until you get close enough.
* [MC-297367](https://mojira.dev/MC-297367) - Checkbox filled status isn't narrated
* [MC-298405](https://mojira.dev/MC-298405) - Text components in the "label" of input controls in dialogs don't support "hover_event"
* [MC-298767](https://mojira.dev/MC-298767) - Piercing arrows phase through mobs that are in the same block
* [MC-298915](https://mojira.dev/MC-298915) - Multishot crossbows loaded in survival or adventure mode show their secondary charged projectiles on a separate line in the tooltip
* [MC-298942](https://mojira.dev/MC-298942) - Character body moves instead of the head when riding a happy ghast
* [MC-299136](https://mojira.dev/MC-299136) - Hyper Potions (Ian Tsuchiura) is not mentioned in the credits and splash texts
* [MC-299196](https://mojira.dev/MC-299196) - Waypoints fade out when an advancement is granted
* [MC-299876](https://mojira.dev/MC-299876) - Labels for booleans within dialogs are rendered in a slightly different shade of white than normal
* [MC-300588](https://mojira.dev/MC-300588) - Waypoint modifications reset upon death
* [MC-300642](https://mojira.dev/MC-300642) - When texture atlases are large, gaps are rendered between blocks that have a low resolution
* [MC-300979](https://mojira.dev/MC-300979) - The movement and duration messages in the demo introduction screen now have a text shadow
...
* [MC-301271](https://mojira.dev/MC-301271) - Object text components do not render in some places unless there are text glyphs on the same line
* [MC-301311](https://mojira.dev/MC-301311) - The “Transfer Now” button no longer renders highlighted when the java realms information box is selected
* [MC-301424](https://mojira.dev/MC-301424) - entity_data item component detection is broken in resource packs
* [MC-301516](https://mojira.dev/MC-301516) - The mouse cursor doesn’t change to the hand shape when hovering over tabs in the “Create New World” menu and similar screens
* [MC-301517](https://mojira.dev/MC-301517) - The mouse cursor doesn’t change to the hand shape when hovering over arrows in the singleplayer, multiplayer, resource packs, and data packs menus
* [MC-301518](https://mojira.dev/MC-301518) - The mouse cursor doesn’t change to the hand shape when hovering over checkboxes
* [MC-301520](https://mojira.dev/MC-301520) - The mouse cursor doesn’t change to the hand shape when hovering over the difficulty lock button
* [MC-301527](https://mojira.dev/MC-301527) - The mouse cursor doesn’t change to the resize shape when scrolling in the advancements menu
* [MC-301557](https://mojira.dev/MC-301557) - The shading direction of the bolts on single and large copper chests does not match
* [MC-301595](https://mojira.dev/MC-301595) - Music toasts briefly appear in the pause menu after a song has finished
* [MC-301632](https://mojira.dev/MC-301632) - Comparators measuring jukeboxes do not update when a music disc is taken out of a jukebox if the music disc has already finished its song
* [MC-301754](https://mojira.dev/MC-301754) - The hand animation plays when right-clicking shelves with nothing in your hand
* [MC-301756](https://mojira.dev/MC-301756) - The “This is a Snapshot Realm…” box outline is rendered above the delete realm interface
* [MC-301763](https://mojira.dev/MC-301763) - The outline of the “Invited” element within the realms “Players” tab renders above other tabs when selected and when a scroll bar is present
* [MC-301805](https://mojira.dev/MC-301805) - Selected item outline on statistics screen renders outside of scissor area
* [MC-301879](https://mojira.dev/MC-301879) - Double weathered and waxed weathered copper chests' bottom texture looks off compared to the other variants
* [MC-301988](https://mojira.dev/MC-301988) - Buttons in the telemetry screen are not aligned properly in some languages
* [MC-302030](https://mojira.dev/MC-302030) - Setting commandBlocksEnabled to false prevents command blocks from being edited
* [MC-302071](https://mojira.dev/MC-302071) - Single and double copper chests have inconsistent side textures
* [MC-302111](https://mojira.dev/MC-302111) - Elements within the resource pack and data pack menus are not selected in order when using the TAB key
* [MC-302184](https://mojira.dev/MC-302184) - Copper golems in cave/void air never turn into statues
* [MC-302209](https://mojira.dev/MC-302209) - Debug renderers stop working when changing dimensions
* [MC-302246](https://mojira.dev/MC-302246) - Sprite object component does not render in server list depending on component tree
* [MC-302254](https://mojira.dev/MC-302254) - Cursor changes do not work for command suggestions
* [MC-302288](https://mojira.dev/MC-302288) - All shelves have the oak tan map color
* [MC-302325](https://mojira.dev/MC-302325) - When the player toggles a debug renderer using its hotkey (F3+B, F3+G) while in the debug options screen, the corresponding entry is not updated
* [MC-302338](https://mojira.dev/MC-302338) - The narrator button in the Accessibility Settings menu doesn't update upon pressing Ctrl+B
* [MC-302362](https://mojira.dev/MC-302362) - Clicking on "Singleplayer" or "Multiplayer" in the main menu then immediately clicking on a world or server joins it even when not clicking the play button
* [MC-302409](https://mojira.dev/MC-302409) - Lightning that strikes waxed lightning rods do not deoxidize nearby unwaxed copper blocks
* [MC-302469](https://mojira.dev/MC-302469) - Creepers at the player's exact position with an explosion radius of 0 set the player's velocity to NaN
* [MC-302477](https://mojira.dev/MC-302477) - Loot tables stopped supporting SNBT as entity data
* [MC-302482](https://mojira.dev/MC-302482) - Resource and data pack names can overlap selection boxes when the scroll bar is present
* [MC-302493](https://mojira.dev/MC-302493) - The mouse cursor doesn't change to the hand shape when hovering over the close button in the "Add Realm" screen
* [MC-302516](https://mojira.dev/MC-302516) - Zombie villagers spawn as the variant matching the biome at 0, 0, 0
* [MC-302549](https://mojira.dev/MC-302549) - Server main thread deadlock during respawn position resolution when the entire world spawn radius is filled with fluids
* [MC-302601](https://mojira.dev/MC-302601) - A white outline is rendered on anvils' top texture when viewed from far away