...
## Coral Zombie Nautilus {{< wiki "Zombie_Nautilus" >}}
  ...
  * Added a new variant of the Zombie Nautilus mob: the Coral Zombie Nautilus
  ...
  <img src="/vinc-custom-changelog.github.io/images/25w45a/coral_nautilus.png" alt="" style="width:600px;"/>
  
  * It Spawns in Warm Oceans, replacing the normal Zombie Nautilus

  {{< command >}}/summon minecraft:zombie_nautilus ~ ~ ~ {variant:warm}{{< /command >}}
