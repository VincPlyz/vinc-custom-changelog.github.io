...
Slicedlime Videos: [Normal](https://www.youtube.com/watch?v=-Lyn7aBevNc) / [Technical](https://www.youtube.com/watch?v=Rg52DxX0_t0)
...
# Fixed bugs in 25w43a
  ...
  * [MC-302669](https://mojira.dev/MC-302669) - Banners sometimes show incorrect textures when viewed from some angles
  * [MC-302675](https://mojira.dev/MC-302675) - Some item frames do not render their item correctly after world upgrade
  * [MC-302691](https://mojira.dev/MC-302691) - Held and dropped items sometimes fail to render correctly when banners exist in the world
  * [MC-302695](https://mojira.dev/MC-302695) - Can use the game mode switcher while the game is paused, and doing so unpauses the game
  * [MC-302719](https://mojira.dev/MC-302719) - Debug key binds text is improperly capitalized
  * [MC-302724](https://mojira.dev/MC-302724) - The "debug.entry.overlay" string is improperly capitalized
  * [MC-302737](https://mojira.dev/MC-302737) - After using the game mode switcher, you need to press F3 twice to toggle the debug overlay
  * [MC-302769](https://mojira.dev/MC-302769) - Several blocks now turn invisible at short distances
  * [MC-302790](https://mojira.dev/MC-302790) - The minecraft:apply_impulse effect cannot be used in minecraft:location_changed
  * [MC-302849](https://mojira.dev/MC-302849) - Mobs with spears deal too little damage
  * [MC-302854](https://mojira.dev/MC-302854) - Glass is less transparent when viewed from far away
  * [MC-302872](https://mojira.dev/MC-302872) - Severe color contrast between lava mip levels
  ...
  * [MC-302912](https://mojira.dev/MC-302912) - Zombie nautiluses suffocate out of water, unlike other undead mobs
  * [MC-302915](https://mojira.dev/MC-302915) - Mipmapping on cutout textures can cause them to appear larger than they should
  * [MC-302963](https://mojira.dev/MC-302963) - Killing a player's mounted nautilus will cause that player to briefly glide upward, unaffected by gravity
  * [MC-302984](https://mojira.dev/MC-302984) - Holding a spear in the off hand and attacking an entity adds the spear's attack damage to the attack
  * [MC-303032](https://mojira.dev/MC-303032) - Nautiluses can still be controlled normally even when they are babies or untamed
  * [MC-303138](https://mojira.dev/MC-303138) - Piglins and hoglins can zombify in the nether
  * [MC-303150](https://mojira.dev/MC-303150) - Can't lay in bed during the day even with "can_sleep" set to "always" and "playerSleepPercentage" set to 101+
  * [MC-303157](https://mojira.dev/MC-303157) - remove_binomial enchantment effect has a chance of producing out-of-range values
  * [MC-303166](https://mojira.dev/MC-303166) - /stopwatch create suggests existing stopwatches
  * [MC-303181](https://mojira.dev/MC-303181) - Spears have an attribute modifier for attack_damage for both hands, even though the charge attack does not use it
  * [MC-303201](https://mojira.dev/MC-303201) - Zombified piglins attack players in Creative mode
  * [MC-303266](https://mojira.dev/MC-303266) - Nautiluses and zombie nautiluses can enter boats
  * [MC-303381](https://mojira.dev/MC-303381) - Game crashes when serializing a world spawn point with yaw or pitch values outside of rotation bounds
  * [MC-303382](https://mojira.dev/MC-303382) - Player spawn points with rotation values outside of bounds aren't serialized
