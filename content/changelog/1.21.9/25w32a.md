...
* The weather\_state field now expects a string id instead of integer id
  + 0 -> unaffected
  + 1 -> exposed
  + 2 -> weathered
  + 3 -> oxidized
...
* Added harvest/sweet\_berry\_bush loot table for drops when a Sweet Berry Bush with Sweet Berries is harvested by interacting with it
