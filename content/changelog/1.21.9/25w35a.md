...
description: "Alle Änderungen und Neuigkeiten in Minecraft Snapshot 25w35a."
...
<div class="mc-header">
  <img src="https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/screenshots/25w35a%201170x500.jpg" alt="25w35a Header" />
...
{{< command >}}/title @s title {atlas:"minecraft:blocks",sprite:"block/stone"}{{< /command >}}

{{< command >}}/setblock ~ ~ ~ oak_sign{front_text:{messages:[{"sprite":"block/crafting_table_top","atlas":"minecraft:blocks","color":"white"},"","",""]}}{{< /command >}}
