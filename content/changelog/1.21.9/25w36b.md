...
<div class="image-comp" style="--max-width: 1339px;">
  <div id="left">
    <img src="https://i.imgur.com/MqU1Uov.png" alt="Alt" />
    <span class="alt-text-overlay top-left">Alt</span>
  </div>
  <div id="right">
    <img src="https://i.imgur.com/XeJkWrK.png" alt="Neu" />
  </div>
  <span class="alt-text-overlay top-right">Neu</span>
...
<div class="image-comp" style="--max-width: 1339px;">
  <div id="left">
    <img src="https://i.imgur.com/a24CYY3.png" alt="Alt" />
    <span class="alt-text-overlay top-left">Alt</span>
  </div>
  <div id="right">
    <img src="https://i.imgur.com/RlzWkcT.png" alt="Neu" />
  </div>
  <span class="alt-text-overlay top-right">Neu</span>
  <input type="range" min="0" max="100" value="50"
    oninput="this.parentNode.style.setProperty('--slider-pos', this.value + '%')">
